...
#  $id$
"""
Make gsw_saar_data.h from the current gsw_data_v3_0.nc.  This is a developer
utility and not a part of the public distribution, but its end-product is.
Note that it generates gsw_saar_data.h but will not overwrite it if it exists.
...
fname = "gsw_saar_data.h"
if os.path.exists(fname):
    print("Will not overwrite existing gsw_saar_data.h. Exiting.")
    sys.exit(1)
